      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 justify-items-center md:justify-items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-4 font-dancing text-center md:text-left">
              Doçuras & Sabores
            </h3>
            <p className="text-white/90 mb-6 text-center md:text-left max-w-md">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-semibold mb-4 text-center md:text-left">Navegação</h4>
            <ul className="space-y-2 text-center md:text-left">
              ...
              <li>
                <Link to="/avaliacoes" className="text-white/80 hover:text-white transition-colors">
                  Avaliações
                </Link>
              </li>
            </ul>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-semibold mb-4 text-center md:text-left">Fale Conosco</h4>
