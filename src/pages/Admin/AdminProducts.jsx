...
const AdminProducts = () => {
  ...
  const createNewProduct = async () => {
    ...
    try {
      ...
      // 🔧 URL da API com fallback - USANDO XAMPP (porta 8000)
      const apiUrl = 'http://localhost:8000/insert_products.php'
  ...
  const filteredProducts = products.filter(product => {
    // Se houver termo de busca, verificar se o produto corresponde
    ...
    const matchesSearch = !hasSearchTerm || 
                         ...
                         (product.tags && Array.isArray(product.tags) && product.tags.some(tag => tag.toLowerCase().includes(searchLower)))
    ...
    // Debug apenas quando houver busca
    if (hasSearchTerm && matches) {
      console.log('✅ Produto encontrado:', product.name, '- Categoria:', product.category, '- Busca:', searchTerm)
    }
  ...
  useEffect(() => {
    if (products.length > 0) {
      console.log('🔍 Busca:', searchTerm || '(vazia)')
      ...
      if (filteredProducts.length === 0 && products.length > 0) {
        console.warn('⚠️ Nenhum produto corresponde aos filtros!')
  ...
  return (
    <div className="space-y-4 sm:space-y-5 lg:space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2 text-sm sm:text-base"
            >
              <span>🔄</span>
            ...
            <button 
              ...
              className="px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2 text-sm sm:text-base"
            >
      ...
      <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-xl shadow-sm border border-gray-200">
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <select
              ...
              className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-4 sm:p-5 lg:p-6 border-b border-gray-200">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Catálogo de Produtos</h2>
          <p className="text-sm sm:text-base text-gray-600 mt-1">{sortedProducts.length} produtos encontrados</p>
        </div>
        ...
        {products.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">Adicione produtos ao catálogo para começar.</p>
            <button
              onClick={openNewProductModal}
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-2">
              {searchTerm ? `Não encontramos produtos com "${searchTerm}"` : 'Nenhum produto corresponde aos filtros selecionados'}
            </p>
            <p className="text-sm text-gray-500">
              {searchTerm && 'Tente buscar por: bolos, tortas, cupcakes, doces, etc.'}
              {!searchTerm && categoryFilter !== 'all' && `Categoria "${categoryFilter}" não possui produtos.`}
            </p>
