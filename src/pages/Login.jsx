  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        if (success) {
          // Sempre redireciona para a página inicial após registro
          navigate('/', { replace: true })
        }
      }
    } catch (error) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <div className="text-center">
            ...
            <h2 className="font-dancing text-4xl bg-gradient-to-r from-purple-300 via-pink-300 to-yellow-400 bg-clip-text text-transparent mb-2">
              Doçuras & Sabores
            </h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-transparent transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-transparent transition-all"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-purple-600 focus:ring-purple-200 border-gray-300 rounded"
                  />
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Cake className="w-5 h-5 text-purple-300" />
                  <span className="text-sm text-gray-600">Pedidos personalizados</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Cake className="w-5 h-5 text-purple-300" />
                  <span className="text-sm text-gray-600">Histórico de pedidos</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Cake className="w-5 h-5 text-purple-300" />
