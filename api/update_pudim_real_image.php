...
try {
    ...
    // URL da imagem real de pudim de leite condensado
    $pudimImage = "https://cozinha365.com.br/wp-content/uploads/2025/02/Pudim-de-Leite-Condensado-S-1024x1024.webp";
    ...
    if ($result) {
        echo "IMAGEM REAL DE PUDIM ATUALIZADA:\n";
        echo "URL: " . $pudimImage . "\n";
